...
For **Task 2, 3, and 4**, the client requires Diffie-Hellman parameters ( and ) to be set in the environment.

Run the following commands in your terminal **before** starting the client:
...
_Note: If you close the terminal, you must export these variables again._
...
- **Observation:** Output will show `[Cipher]: <hex>` and `[Plain]: <text>`.
...
2. **GeeksforGeeks - AES Encryption in Python:**
   [https://www.geeksforgeeks.org/advanced-encryption-standard-aes-python/](https://www.google.com/search?q=https://www.geeksforgeeks.org/advanced-encryption-standard-aes-python/)
...
4. **PyCryptodome Documentation (AES CBC Mode):**
   [https://pycryptodome.readthedocs.io/en/latest/src/cipher/classic.html#cbc-mode](https://www.google.com/search?q=https://pycryptodome.readthedocs.io/en/latest/src/cipher/classic.html%23cbc-mode)
